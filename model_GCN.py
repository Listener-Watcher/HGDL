...
class Gtransformerblock(nn.Module):
    def __init__(
        self,args,in_dim,hid_dim,out_dim,attention_dim,num_heads,adj_list,features,labels, train_mask,val_mask,test_mask,device,dropout=0.0, layer_norm=True, use_bias=False,gamma=0.0001):
        super().__init__()
